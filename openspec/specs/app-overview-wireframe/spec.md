# App Overview Wireframe Spec

## Purpose

Defines the requirements for the "App 結構總覽" card at the top of the 說明 (Help) tab, which gives new users a spatial overview of all 6 panels before reading the step-by-step instructions.
