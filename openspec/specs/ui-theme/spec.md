...
Defines the visual theme requirements for the app's Apple-inspired warm-neutral UI, covering background colors, card surfaces, accent colors, borders, and typography.
