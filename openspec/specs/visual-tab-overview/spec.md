# Visual Tab Overview Spec

## Purpose

Defines the requirements for the CSS phone-frame mockup overview card displayed at the top of the 說明 (Help) tab, showing a visual representation of all 6 navigation tabs.
