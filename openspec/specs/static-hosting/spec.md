...
Defines requirements for hosting the competition scoring tool as a static site, making it publicly accessible without local file access or manual deployment steps.
