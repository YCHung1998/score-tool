...
This spec defines the requirements for the in-app user guide (Help tab), which provides instructional content to help users navigate and use the app's major features.
